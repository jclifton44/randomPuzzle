...
public class TestSudoku {
 ...
 @Test(timeout=20000)
  public void testTcHard2() {
    String result = SudokuSolver.solve( hardTc2 );
    assertTrue( SudokuSolver.isLegalSolution( result,  hardTc2 ));
    score += 5;
  }
  @Test(timeout=20000)
  public void testTcHard3() {
    String result = SudokuSolver.solve( hardTc3 );
    assertTrue( SudokuSolver.isLegalSolution( result,  hardTc3 ));
    score += 5;
  }
